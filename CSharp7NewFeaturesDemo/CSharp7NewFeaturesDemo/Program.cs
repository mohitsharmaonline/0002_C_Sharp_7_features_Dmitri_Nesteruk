...
namespace CSharp7NewFeaturesDemo
{
    class Program
    {
        // C# 7 allows custom return types.
        ...
        // For using ValueTasks, you need to have Nuget package
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(GetDirSize(@"C:\Users\mohit\Documents\0001_Pluralsight_WPF_XAML_Fundamentals").Result);
